...
***************************************************************************/
#ifndef MDTRA_DISTANCESEARCHRESULTSDIALOG_H
#define MDTRA_DISTANCESEARCHRESULTSDIALOG_H

#include <QtGui/QDialog>

#include "ui_distanceSearchResultsDialog.h"

class MDTRA_MainWindow;

class MDTRA_DistanceSearchResultsDialog : public QDialog, public Ui_distanceSearchResultsDialog
{
	Q_OBJECT

public:
    MDTRA_DistanceSearchResultsDialog( QWidget *parent = 0 );
...
#endif //MDTRA_DISTANCESEARCHRESULTSDIALOG_H