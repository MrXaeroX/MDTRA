...
***************************************************************************/
#ifndef MDTRA_FORCESEARCHDIALOG_H
#define MDTRA_FORCESEARCHDIALOG_H

#include <QtGui/QDialog>

#include "ui_forceSearchDialog.h"
...
class MDTRA_ForceSearchDialog : public QDialog, public Ui_forceSearchDialog
{
	Q_OBJECT

	friend void forcesearch_print_f( const QString &msg );
	friend void forcesearch_select_f( const MDTRA_SelectionSet<MDTRA_PDB_File>* pSet );
	friend void forcesearch_select2_f( const MDTRA_SelectionSet<MDTRA_PDB_File>* pSet );

public:
    MDTRA_ForceSearchDialog( QWidget *parent = 0 );
	virtual ~MDTRA_ForceSearchDialog();
	virtual bool event( QEvent *ev );

	const struct stMDTRA_ForceSearchInfo* getForceSearchInfo( void ) const { return pFsInfo; }
...
private:
	...
	struct stMDTRA_ForceSearchInfo *pFsInfo;
};

#endif //MDTRA_FORCESEARCHDIALOG_H